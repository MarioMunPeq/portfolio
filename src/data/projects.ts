...
export const projects: Project[] = [
  {
    ...
    features: [
      { name: 'Búsqueda instantánea', description: 'Una única búsqueda para todo el Compendio. Los resultados aparecen mientras escribes gracias a un índice construido previamente y mantenido en memoria, sin red ni servidor.' },
      { name: 'Compendio sin conexión', description: 'Toda la referencia del SRD de D&D 5e —hechizos, monstruos, equipo, condiciones, acciones, objetos mágicos y dotes— está integrada en la aplicación durante el proceso de compilación y disponible sin conexión.' },
      { name: 'Relaciones entre entidades', description: 'Las entidades están conectadas entre sí. Un hechizo muestra las condiciones relacionadas y un monstruo muestra los hechizos y el equipo que utiliza o referencia.' },
      { name: 'Gestión de personajes', description: 'Hojas de referencia ligeras para jugadores: nombre, clase, nivel, características y referencias a hechizos, armas y objetos mágicos conocidos.' },
      { name: 'Seguimiento de combate', description: 'Puntos de golpe por personaje con ajustes rápidos de daño y curación, panel de condiciones activables con un toque y acceso inmediato a las estadísticas de combate más consultadas.' },
      { name: 'Tirada de dados', description: 'Permite lanzar cualquier dado tantas veces como sea necesario, con modificador opcional. Los dados de daño de los hechizos también pueden lanzarse directamente desde la hoja de personaje.' },
      { name: 'Marcadores de sesión', description: 'Guarda monstruos, hechizos y objetos en la sesión actual con un solo toque y permite eliminarlos todos al finalizar la sesión.' },
      { name: 'Favoritos y recientes', description: 'Marca entidades como favoritas y recuerda lo que has consultado y buscado recientemente.' },
      { name: 'Modo principiante', description: 'Activa consejos que explican conceptos como el d20, las pruebas de característica y qué puedes hacer durante tu turno de combate.' },
      { name: 'Referencia de reglas', description: 'Una referencia integrada para turnos de combate, ataques, puntos de golpe, descansos y lanzamiento de hechizos, además de un glosario explicado en lenguaje sencillo.' },
      { name: 'Copia de seguridad en la nube', description: 'Inicio de sesión opcional con Google para subir y restaurar manualmente los datos locales mediante Firestore. El resto de la aplicación funciona completamente sin conexión.' },
      { name: 'Aplicación web progresiva', description: 'PWA instalable, con almacenamiento en caché sin conexión mediante un service worker. Funciona completamente offline y no requiere una cuenta.' },
    ],
    conceptBlock: {
      ...
      highlights: ['Sin cuenta', 'Sin conexión a Internet', 'Datos almacenados localmente', 'Copia de seguridad opcional en la nube'],
    },
    designSystem: {
      title: 'Sistema de diseño',
      description: 'La interfaz sigue un sistema de diseño documentado en lugar de evolucionar como una colección de pantallas independientes.',
      points: [
    ...
    architecture: {
      title: 'Arquitectura',
      description: 'Una aplicación cliente de una sola página dividida en tres capas desacopladas.',
      layers: [
        { number: '01', title: 'Compendio', description: 'Datos de referencia de D&D 5e generados durante el proceso de compilación: 7 categorías, identificadores canónicos estables e índice de relaciones entre entidades.' },
        { number: '02', title: 'Estado del usuario', description: 'Estado local versionado y persistido en localStorage. Incluye favoritos, marcadores de sesión, hojas de personaje y preferencias.' },
        { number: '03', title: 'Aplicación React', description: 'Páginas funcionales e interacciones coordinadas mediante React Router y construidas sobre el sistema de diseño.' },
      ],
    },
    closingLine: 'La aplicación se consulta y después se aparta. Nunca debería ser el motivo por el que una sesión se ralentiza.',
    ...
    challenges: {
      ...
      items: [
        { label: 'Offline-first', detail: 'Diseñar una arquitectura que funcione completamente sin Internet, con sincronización opcional a la nube.' },
        { label: 'Índice de búsqueda', detail: 'Construir un índice en memoria durante la compilación que permita búsquedas instantáneas entre miles de entidades.' },
        { label: 'Persistencia local', detail: 'Implementar un sistema de versionado de estado en localStorage que mantenga la integridad de los datos entre sesiones.' },
        { label: 'Service worker', detail: 'Configurar una estrategia de caché que mantenga la aplicación funcional sin conexión y se actualice en segundo plano.' },
      ],
    },
  },
  {
