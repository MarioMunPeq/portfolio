  ...
  return (
    <li className="hero-command-item">
      ...
      >
        ...
        <span className="ml-auto hidden self-center whitespace-nowrap font-hatty text-[14px] uppercase tracking-[0.06em] text-paper/50 [transform:skewX(11deg)] transition-colors duration-200 group-hover:text-ink/70 group-focus-visible:text-ink/70 md:block lg:text-[15px]">
          {sub}
        </span>
      </Link>
    </li>
