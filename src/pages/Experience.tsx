...
// Silueta del panel de diálogo: esquinas cortadas con ángulo agresivo.
// La cola (triángulo negro) se pinta con un elemento propio bajo el panel,
// porque clip-path no puede añadir píxeles fuera de la caja del elemento.
const BUBBLE_LEFT =
...
// Ritmo de composición por mensaje (escritorio): posición horizontal, ancho,
// rotación y desplazamiento de la sombra dura. Los bordes interiores de cada
...
// Ruta negra de conversación (Persona 5): UN único camino continuo que
// zigzaguea entre los mensajes. Técnicamente es un trazo por hueco, pero cada
...
// línea que se enrosca detrás de cada tarjeta.
//
//   leftPct   — punto de salida visible (borde de la tarjeta superior), en %
//               del ancho de contenido.
//   shiftPx   — corrección del origen skew (tan(ángulo) × saliente superior)
//               para que `left` coincida con el borde visible en el hueco.
//   ángulo    — 28° = giro agudo y marcado; el saliente superior/inferior
...
/* ============================================================
   Cabecera integrada sobre el rojo. Jerarquía:
   PROGRESO (título dominante, Persona 5) → EXPERIENCIA LABORAL
   ============================================================ */
...
/* ============================================================
   Barra de "conversación" (etiquetas pequeñas del historial)
   ============================================================ */
...
/* ============================================================
   ...
   anillo blanco y ligera rotación, al lado de la tarjeta.
   ============================================================ */
...
/* ============================================================
   Un mensaje de la conversación: hueco de entrada con el tramo de
...
function MessageBlock({ entry, index }: { entry: ExperienceEntry; index: number }) {
  ...
  return (
    <div className="group">
      {/* Hueco entre tarjetas: aquí vive el tramo de la ruta que conecta este
      ...
      >
        ...
        >
          <div className="relative">
            {/* Cola negra del diálogo (baja sobre el rojo) */}
            <span
              aria-hidden="true"
            ...
            {/* Número de mensaje (etiqueta gráfica) */}
            <span
              aria-hidden="true"
  ...
  return (
    <Screen className="min-h-dvh bg-[#B80404] text-white">
      <section className="relative min-h-dvh overflow-x-clip pt-11 md:pt-12">
        ...
        {/* Conversación de experiencias. Los huecos entre mensajes son parte
